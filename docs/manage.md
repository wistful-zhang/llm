...
<div class="owner-notice" role="note">
  ...
  <span>只有拥有目标仓库写入权限的 GitHub 用户才能保存；其他访客可以创建自己的题库，或通过 GitHub 投稿与纠错。</span>
</div>
...
<nav class="journey-grid" aria-label="选择操作">
  ...
  {% if site.github.repository_url %}<a class="journey-card" href="{{ site.github.repository_url }}/issues/new/choose" target="_blank" rel="noopener noreferrer"><strong>向当前题库投稿</strong><span>只提交问题也可以，不需要拥有仓库写入权限。</span><b>打开投稿与纠错 →</b></a>{% endif %}
</nav>
