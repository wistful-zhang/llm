...
<section id="question-only-workflow" class="capture-panel question-only-workflow">
  ...
  <p><strong>以后让我回答：</strong>打开这道题的阅读页，点击“复制给 Codex 的补答指令”，回到 Codex 粘贴即可。我会补答案，把答案状态改成“已完成”，校验后同步 GitHub。</p>
...
<section id="capture-workflow" class="capture-panel">
  <span class="status-badge">不想公开：先速记，再整理</span>
  <h2>刚面试完：先保存为个人草稿</h2>
  <p>不要等答案写完整。趁记忆还清楚，先保存问题原貌和现场思路。</p>
  <ol class="capture-steps">
    <li>打开“面试题与解答”，点击 <strong>Add an entry</strong>（手机端是 <code>+</code>）。</li>
    <li>只需先填写<strong>面试题目</strong>；“解答 / 私下整理区”可以留空，也可以写关键词、自己的回答和追问。</li>
...
<ol class="daily-steps">
  <li><strong>补全答案</strong><span>可以自己写，也可以从待解答题页面复制指令交给 Codex。</span></li>
